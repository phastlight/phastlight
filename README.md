...
For more details on the memcached tcp protocol, please click [here](http://memcachedb.googlecode.com/svn/trunk/doc/protocol.txt), we can now create some async memcache just by following the protocol.
